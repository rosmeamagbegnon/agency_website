const Caring = () => {
    const blogs = [
        ...
        return ( 
            <div className="bg-white mx-auto py-8 md:py-16">
               <div className="pb-8 text-center mb-6 mx-auto lg:w-1/2">
                   ...
                   
                   {
                    ...
                    <div key={blog.id} className="relative mb-8">
                         ...
                         <div className=" justify-center flex items-center gap-4 mb-4 ">
                            <a href="" className="text-2xl text-green-600 font-semibold cursor-pointer hover:text-green-800  "> Read more 
